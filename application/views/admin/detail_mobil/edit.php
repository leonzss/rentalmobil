...
echo form_open_multipart("admin/detail_mobil/edit/".$hasil['NEWS_ID'],$attributes);
?>
    ...
    <input name="news_title" type="text" id="news_title" placeholder="input merk mobil" value="<?php echo set_value("news_title");
?>" size="100%" required>
    <br /><br />
